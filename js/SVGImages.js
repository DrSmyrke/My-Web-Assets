class SVGImages{
	...
	constructor( debug = false )
	{
		this.images				= {
			...
			gem: { width: 24, height: 24, img: '<circle cx="12" cy="12" r="9" class="stroke" stroke-linecap="round" stroke-linejoin="round"/><path d="M9 8L7 12L9 16L12 17L15 16L17 12L15 8L12 7L9 8Z" class="stroke" stroke-linecap="round" stroke-linejoin="round"/><path d="M9 16L6.5 19" class="stroke" stroke-linecap="round" stroke-linejoin="round"/><path d="M15 16L17.5 19" class="stroke" stroke-linecap="round" stroke-linejoin="round"/><path d="M9 8L7 5" class="stroke" stroke-linecap="round" stroke-linejoin="round"/><path d="M15 8L17 5" class="stroke" stroke-linecap="round" stroke-linejoin="round"/><path d="M7 12H3" class="stroke" stroke-linecap="round" stroke-linejoin="round"/><path d="M21 12H17" class="stroke" stroke-linecap="round" stroke-linejoin="round"/>' },
			...
			refresh_ccw: { width: 24, height: 24, img: '<polyline class="stroke" points="1 4 1 10 7 10"></polyline><polyline class="stroke" points="23 20 23 14 17 14"></polyline><path class="stroke" d="M20.49 9A9 9 0 0 0 5.64 5.64L1 10m22 4l-4.64 4.36A9 9 0 0 1 3.51 15"></path>' },
			...
			thumb_down: { width: 24, height: 24, img: '<path class="stroke" d="M10 15v4a3 3 0 0 0 3 3l4-9V2H5.72a2 2 0 0 0-2 1.7l-1.38 9a2 2 0 0 0 2 2.3zm7-13h2.67A2.31 2.31 0 0 1 22 4v7a2.31 2.31 0 0 1-2.33 2H17"></path>' },
			thumb_up: { width: 24, height: 24, img: '<path class="stroke" d="M14 9V5a3 3 0 0 0-3-3l-4 9v11h11.28a2 2 0 0 0 2-1.7l1.38-9a2 2 0 0 0-2-2.3zM7 22H4a2 2 0 0 1-2-2v-7a2 2 0 0 1 2-2h3"></path>' },
